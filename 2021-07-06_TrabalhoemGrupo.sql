...
NOME: Luís Antônio Nascimento Junior
NOME: Leonardo Rodrigues de Castro
...
/*
 2 - Adicione uma nova tabela a base de dados que contenha pelo menos 3 colunas. Adicione 5 registros a essa tabela (0,5)
 */
...
alter table biblioteca drop column data_retirada;
/*
...
/*
5. Pesquise por todos os alunos com nota inferior a 6 que realizaram a disciplina BANCO DE DADOS durante os anos de 2015 a 2019.
...
/*
7. Pesquise por todas as disciplinas de cada curso. Ordene o resultado por nome do curso em ordem crescente
 e pelo nome da disciplina em ordem decrescente. (1,0)
*/
 ...
 /*
 8. Pesquise a quantidade de disciplina que cada curso possui. Informe o nome do curso seguido pela Quantidade.
...
/* Modo 2
select nome, nota from alunos, historico where nota = (select max(nota) from historico) 
and alunos.matricula = historico.matricula 
and codigo = '1'; 
*/

/*
11. Crie um comando utilizando LEFT JOIN 
(Obs. Acrescentar registros no exercício 1 que atenda a este requisito). (1,0)
*/
select * from alunos left join biblioteca on alunos.matricula = biblioteca.matricula;
